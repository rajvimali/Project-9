    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class=" ">
              <Link to={"/"} class="navbar-brand nav-link fw-bolder fs-5" >Home</Link>
            </li>
            {flag ? <><li class="">
              <Link to={"/student"} class="nav-link fs-5" >StudentList</Link>
            </li>
              <li class="nav-item">
                <a href="" className='nav-item nav-link fs-5' onClick={handleLogout}>Logout</a>
              </li> </> : <>
              <li class="nav-item">
